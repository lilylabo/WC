...
<p class="opt_ex"><?php echo apply_filters('usces_filter_single_item_options_caption', __('Please appoint an option.', 'usces'), $post); ?></p>
<dl class='item_option autocharge'>
...
<?php endif; ?>
<div class="dlseller_data_button"><?php echo apply_filters('usces_filter_autocharge_price_label', usces_the_itemSkuDisp('return')); ?><?php usces_the_itemSkuButton(__('Add to Shopping Cart', 'usces'), 0); ?></div>
</div><!-- end of skuform -->
