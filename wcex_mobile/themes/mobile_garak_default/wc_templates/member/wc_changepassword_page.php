...
<div id="memberpages">
	...
	<p>
		...
		<input type="password" name="loginpass1" id="loginpass1" class="loginpass" value="" size="20"<?php wcmb_set_istyle( WCMB_ISTYLE_ALP ) ?> /></label>
	</p>
	<p>
		<label><?php _e('Password (confirm)', 'usces'); ?><br />
		<input type="password" name="loginpass2" id="loginpass2" class="loginpass" value="" size="20"<?php wcmb_set_istyle( WCMB_ISTYLE_ALP ) ?> /></label>
	</p>
	<p class="submit">
