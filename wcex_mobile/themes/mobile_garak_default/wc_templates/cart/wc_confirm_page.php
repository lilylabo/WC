...
<?php if( usces_is_member_system() && usces_is_member_system_point() && !empty($usces_entries['order']['usedpoint']) ) : ?>
			<tr>
				...
				<td class="aright"><span class="discount"><?php echo number_format($usces_entries['order']['usedpoint']); ?></span></td>
			</tr>
<?php endif; ?>
<?php if( !empty($usces_entries['order']['discount']) ) : ?>
			<tr>
				...
				<td class="aright"><span class="discount"><?php usces_crform($usces_entries['order']['discount'], true, false); ?></span></td>
			</tr>
<?php endif; ?>
			<tr>
...
<?php endif; ?>
	...
	<table id="confirm_table">
		...
		<tr><td class="aright"><a href="<?php echo USCES_CART_URL; ?>&backdelivery3=1">配送日・支払方法を変更する</a></td></tr>
		<?php wcmb_custom_field_info($usces_entries, 'order', ''); ?>
		<tr><th><?php _e('Notes', 'usces'); ?></th></tr>
		<tr><td><?php echo nl2br($usces_entries['order']['note']); ?></td></tr>
	</table>
