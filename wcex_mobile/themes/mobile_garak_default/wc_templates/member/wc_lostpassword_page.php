...
<div class="whitebox">
	...
	<input type="text" name="loginmail" id="loginmail" class="loginmail" value="" size="20" <?php wcmb_set_istyle( WCMB_ISTYLE_ALP ) ?>/></label>
	</p>
	<p class="submit">
	<input type="submit" name="lostpassword" id="lostpassword" value="<?php _e('Obtain new password', 'usces'); ?>" />
	</p>
