...
<div id="newmember">
	...
	<table border="0" cellpadding="0" cellspacing="0" class="customer_form">
		<tr><th scope="row" colspan="2" align="left"><span class="em"><?php _e('*', 'usces'); ?></span><?php _e('e-mail adress', 'usces'); ?></th></tr>
		...
		<tr><th scope="row" colspan="2" align="left"><span class="em"><?php _e('*', 'usces'); ?></span><?php _e('E-mail address (for verification)', 'usces'); ?></th></tr>
		<tr><td colspan="2"><input name="member[mailaddress2]" id="mailaddress2" type="text" value="<?php usces_memberinfo('mailaddress2'); ?>"<?php wcmb_set_istyle( WCMB_ISTYLE_ALP ) ?> /></td></tr>
		<tr><th scope="row" colspan="2" align="left"><span class="em"><?php _e('*', 'usces'); ?></span><?php _e('password', 'usces'); ?></th></tr>
		...
		<tr><th scope="row" colspan="2" align="left"><span class="em"><?php _e('*', 'usces'); ?></span><?php _e('Password (confirm)', 'usces'); ?></th></tr>
