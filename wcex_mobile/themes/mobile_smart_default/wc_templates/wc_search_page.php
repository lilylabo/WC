...
?>
	<h2 class="result_ttl"><?php _e('Search results', 'usces'); ?>&nbsp;&nbsp;<?php echo number_format($my_query->found_posts); ?><?php _e('cases', 'usces'); ?></h2>

<?php if ($my_query->have_posts()) : ?>	
	<div class="navigation clearfix">
	<?php if( $uscpaged > 1 ) : ?>
		<div class="prev"><a onclick="usces_prepage();"><?php _e('&laquo; Previous article', 'usces'); ?></a></div>
	<?php endif; ?>
	<?php if( $uscpaged < $my_query->max_num_pages ) : ?>
		<div class="next"><a onclick="usces_nextpage();"><?php _e('Next article &raquo;', 'usces'); ?></a></div>
	<?php endif; ?>
	</div>
	...
	<?php while ($my_query->have_posts()) : $my_query->the_post(); 	usces_the_item(); ?>
		<div class="itemlist clearfix">
			...
			<div class="loopexp">
				...
				<div class="field"><?php the_excerpt(); ?></div>
			</div>
		</div>
	<?php endwhile; ?>
	</div><!-- searchitems -->
...
<div class="field">
	...
	<?php do_action('usces_action_search_item_inform'); ?></div>
	</form>
<?php //******* End Form ************** ?>
